<div class="std-srv-content-con">
	<div class="std-srv-content-left-con" style="width: 100%">
		<div class="std-srv-form-con" style="width: 80%">
			<p class="header">Request For Counseling</p>
			<?php
				if(!empty($data['err'])):
			?>
				...
				<li >
					...
					<div class="std-srv-list-content-con" data-li="downloadables">
						<div class="downloadable-group">
							<ul>
								<li>Conset Form <a>download(14.3k/pdf)<img src="<?php echo URLROOT; ?>/public/assets/img/download.png"></a></li>
							</ul>
						</div>
					</div>
				</li>
