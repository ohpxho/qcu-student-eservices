				...
				<div class="table-con">
					<div class="search-filter-con">
						<div class="search-con">
							...
							<p class="subtext">Type something to search for log/s.</p>
						</div>
					...
					<table>
						<tr>
							...
							<th><span>Time<img src="<?php echo URLROOT; ?>/public/assets/img/sort.png" data-orderby="time" class="tbl-order-btn"/></span></th>
							<th><span>User<img src="<?php echo URLROOT; ?>/public/assets/img/sort.png" data-orderby="user" class="tbl-order-btn"/></th>
							<th><span>Action<img src="<?php echo URLROOT; ?>/public/assets/img/sort.png" data-orderby="action" class="tbl-order-btn"/></th>
							<th>Category</th>
							<th><span>Status<img src="<?php echo URLROOT; ?>/public/assets/img/sort.png" data-orderby="status" class="tbl-order-btn"/></th>
						</tr>					
					</table>
				</div>
