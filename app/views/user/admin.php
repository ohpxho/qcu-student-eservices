...
?>
	<div class="users-main-con">
		<div class="users-con">
			<?php
				require APPROOT.'/views/includes/user-navigation.php';
			?>
			<div class="users-student-con">
				<div class="table-con">
					<div class="search-filter-con">
						<div class="search-con">
							<p>Search</p>
							<input type="text" name="search">
							<p class="subtext">Type something to search for admin/s.</p>
						</div>
						<div class="filter-con">
							<img src="<?php echo URLROOT; ?>/public/assets/img/add.png" id="add-form-toggler" title="add new admin">
					...
					<table>
						<tr>
							...
							<th><span>Middlename<img src="<?php echo URLROOT; ?>/public/assets/img/sort.png" data-orderby="mname" class="tbl-order-btn"/></th>
							<th>Contact</th>
							<th><span>Department<img src="<?php echo URLROOT; ?>/public/assets/img/sort.png" data-orderby="contact" class="tbl-order-btn"/></th>
						</tr>					
					</table>
				</div>
				...
				<!--add new user-->
				<div class="add-user-modal-con">
					<div class="add-user-modal">
						<div class="details-header-con">
							<p class="header">Add New Admin</p>
							<img class="details-modal-hide-btn" src="<?php echo URLROOT; ?>/public/assets/img/lack.png">
						</div>
						...
						<div class="details-form-con">
							...
							<div class="form-group">
								...
								<select name="dep">
									...
									<option value="2" >University Registrar</option>
									<option value="3" >Guidance And Counseling</option>
									<option value="4" >Finance And Accounting</option>
									<option value="5" >Library And Information Services</option>
									<option value="6" >Medical And Dental Services</option>
								</select>
							</div><br>
							<p class="details-subtext">Make sure that the details here are true or correct.</p>
							<div class="form-group">
								<button id="std-acc-app-btn">Add New Admin</button>
							</div>
						</div>
					</div>
				</div>
		...
		<script src="<?php echo URLROOT?>/public/script/user.js"></script>
	</div>
